  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 offset-md-3">
        <p class="text-danger" v-if="error">{{ form }}</p>
        ...
        <div class="card my-5">
          <form class="card-body cardbody-color p-lg-5" @submit.prevent="register">
            ...
            <div class="mb-3">
              <input type="text" name="name" class="form-control" id="Username" aria-describedby="emailHelp" v-model="form.name"
                placeholder="User Name">
                <span class="text-danger" >{{ errors.name }}</span>
            </div>
            <div class="mb-3">
              <input type="text" name="email" class="form-control" id="Username" aria-describedby="emailHelp" v-model="form.email"
                placeholder="User email">
                <span class="text-danger" v-text="errors.email"></span>
            </div>
            <div class="mb-3">
              <input type="password" name="password" class="form-control" id="password" v-model="form.password" placeholder="password">
              <span class="text-danger" v-text="errors.password" ></span>
            </div>
